...
export JULIA_PATH=/home/rcaillaud/julia-1.5.1
export JULIA=$JULIA_PATH/bin/julia
export PATH=$PATH:$JULIA_PATH/bin
export PATH=$PATH:/home/rcaillaud/.gem/ruby/2.5.0/bin
export BROWSER='/usr/local/bin/firefox.exe'
export DISPLAY=:0.0
